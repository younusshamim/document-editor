  ...
  return (
    <>
      ...
      <div className={`w-[1000px] p-5 shadow-xl rounded-xl mb-10`}>
        <div
          className={`p-16 border-2 border-dashed rounded-sm flex flex-col gap-4 justify-center items-center cursor-pointer transition-all dropzone ${
        ...
        >
          ...
          <PrimaryButton className="btn-md px-10">
            <div>
              <LuUpload />
            </div>
            <p>Select</p>
